<template>
  <div class="cl-upload">
    ...
    <div v-on:submit.prevent="upload">
      ...
      <button @click="upload" type="submit" :disabled="filesSelected < 1">Upload</button>
